package com.spring.spring_kafka_stream.Controller;


import com.spring.spring_kafka_stream.Producer;
...
public class Controller {
    ...
    //get the message as a complex type via HTTP and publish it to the broker through spring cloud stream
